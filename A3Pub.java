    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            aa: if (k == 1) {
                ...
                mm: do {
                    System.out.println(
                            "\n\t\tMENU FOR MAGAZINE...\n\t\t1. AD\t\t2. DISPLAY\n\t3. SALE MAGAZINE COPIES\t\t4. CIEVE NEW ISSUE\n");
                    int d;
                    System.out.println("\n\tChoice:");
                    d = sc.nextInt();
                    switch (d) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            System.out.println("HOW MANY COPIES YOU T (the customer)?");
                            int n3 = sc.nextInt();
                            m.sale_copy(n3);
                            break;
                        case 4:
                            System.out.println("ENTER THE NEW ISSUE E [dd/mm/yyyy]");
                            String date = sc.next();
                            m.recieve_issue(date);
                            break;
                    }
                    System.out.println(
                            "DO YOU WANT TO CONTINUE WITH MAZINE SECTION?....[1/0] Enter 1 for YES and 0 for NO");
                    System.out.println("Choice:");
                    a = sc.nextInt();
                    if (a == 0) {
                        break mm;
